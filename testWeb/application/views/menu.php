...
<?php
		$j = 0;
		for($i = 0 ; $i < sizeof($menu_item[0]); $i++){
?>
<?php
...
?>
    <tr>
        ...
        <td width="145" height= "30" align="left" valign="middle">
            <b><span style="font-family: gulim; font-size:10pt;"><?php echo $menu_item[0][$i] ?></span></b></td>
        <td width= "10" height= "30" align="center" valign="middle">
            <span style="font-family: gulim; font-size:10pt;"><img src="../../../images/arrow_hide_b.gif" width="7" height="11" border="0" name="arrow_toggle_0<?php echo $j?>" OnClick="toggle_submenu(<?php echo $j?>, <?php echo $menu_item[2][$i]?>); toggle_img_src( 'arrow_toggle_0<?php echo $j?>', '../../../images/arrow_show_b.gif', '../../../images/arrow_hide_b.gif');" style="cursor:pointer"></span></td>
        <td width= "15" height= "30" align="left" background="../../../images/lm_line_right.gif">
            <span style="font-family: gulim; font-size:10pt;">&nbsp;</span></td></tr>
<?php
			}else{
				$k++;
?>        
    <tr id="submenu_group_<?php echo $j?>_<?php echo $k?>" style="">
        <td width= "15" height= "30" align="left" background="../../../images/lm_line_left.gif">
            <span style="font-family: gulim; font-size:10pt;">&nbsp;</span></td>
        <td width= "15" height= "30" align="left">
        ...
        <td width="155" height= "30" align="left" valign="middle" colspan="2">
            <span style="font-family: gulim; font-size:10pt;"><?php echo $menu_item[0][$i] ?></span></td>
        <td width= "15" height= "30" align="left" background="../../../images/lm_line_right.gif">
            <span style="font-family: gulim; font-size:10pt;">&nbsp;</span></td></tr>
